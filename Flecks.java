...
public class Flecks {
    ...
    public Flecks(int screenX, int screenY) {
        maxX = screenX;
        maxY = screenY;
        minX = 0;
        minY = 0;
    ...
    public void update(int playerSpeed) {
        //animating the fleck horizontally left side
        //by decreasing x coordinate with player speed
        x -= playerSpeed;
        x -= speed;
        //if the fleck reached the left edge of the screen
        if (x < 0) {
            //again starting the fleck from right edge
    ...
    public float getFleckWidth() {
        //Making the fleck width random so that
